...
<head>
    ...
    <title>VacinePet - Conheça a Veterinária</title>
...
<body>
    ...
    <div class="fundo">
        ...
        <div class="sobre-profissional">
            ...
            <p id="p1" style="margin-bottom: 20px;">Dra. Luciane Mônica é uma médica veterinária com mais de 20 anos de
                experiência,
                dedicada ao cuidado de pequenos animais, com especial foco em medicina de felinos. Possui
                especializações em
                Homeopatia, Saúde Pública e Medicina de Felinos, é mestre em Ciências pela USP.<br>
            </p>
            <p id="p2" style="margin-bottom: 20px;">Sua atuação inclui serviços práticos e acessíveis, como a aplicação
                de vacinas
                em domicílio e a realização de castrações de felinos, garantindo o conforto e a tranquilidade dos
                tutores e
                de seus pets.<br>
            </p>
            <p id="p3" style="margin-bottom: 20px;"> Com um atendimento atencioso e especializado, Dra. Luciane
                proporciona o melhor
                cuidado possível para a saúde e bem-estar dos animais e seus tutores.
                Com uma carreira sólida e ampla experiência clínica, Dra. Luciane Mônica é a escolha ideal para quem
                busca
                uma veterinária que une conhecimento técnico, experiência e paixão pelos animais.</p>

            <p id="p4"> Entre em contato e agende uma visita para garantir a saúde e o bem-estar do seu pet com o
                cuidado
            ...
            <a class="btn btn-primary" href="#"
                onclick="document.getElementById('modalLogin').showModal(); return false;">Agende agora</a>
            <?php endif; ?>
