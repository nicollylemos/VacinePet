    ...
    <div class="footer">
        ...
        <div class="infos-site">
            ...
            <ul class="duvidas">
                ...
                <li><a href="/VacinePet/conteudo/como-funciona.php">Como funciona o agendamento</a></li>
                <li><a href="/VacinePet/infos-page/vacinacao.php">Vacinação em Domicílio</a></li>
                <li><a href="/VacinePet/infos-page/pagamento.php">Formas de pagamento</a></li>
            </ul>
            <ul>
                <li>
                    <h2>Políticas e Termos</h2>
                </li>
                <li><a href="/VacinePet/infos-page/politicas-privacidade.php">Termos de Uso</a></li>
                <li><a href="/VacinePet/infos-page/politicas-privacidade.php">Política de Privacidade</a></li>
                <li><a href="/VacinePet/infos-page/direitos.php">Direitos Autorais</a></li>
            </ul>
            <ul class="sobre">
                <li>
                    <h2>Sobre nós</h2>
                </li>
                <li><a href="/VacinePet/infos-page/sobre-vacinepet.php">Sobre o VacinePet</a></li>
                <li><a href="/VacinePet/conteudo/profissional.php">Sobre o profissional</a></li>
                <li><a href="/VacinePet/infos-page/vacinacao.php">Sobre o atendimento</a></li>
            </ul>
