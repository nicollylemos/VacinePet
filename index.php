        ...
        * @details Apresenta o serviço de vacinação em domicílio com um botão de agendamento e uma breve descrição dos benefícios da vacinação.
            ...
            <div class="tela-inicial">
                <div class="info-inicial">
                    ...
                    <p id="sub">Vacinar é um ato de amor. Com a chegada do
                        filhote,
                        a responsabilidade aumenta e a imunização contra doenças nos primeiros meses de vida é
                        obrigatória.
                        Ao longo da vida do
            ...
            <div class="fundo-atendimento">
                <div class="conteudo-atend">
                    ...
                    <p class="p-text" style="color: white;">
                        ...
                        doenças, mas ir à clínica pode ser complicado. Para facilitar, oferecemos um sistema de
                        agendamento
        ...
        <dialog class="modalLog" id="modalLogin">
            <div class="modalLogin">
                ...
                <p>Não tem uma conta? <a href="/VacinePet/usuario/cadastro.php" class="cadastrar">Cadastre-se aqui!</a>
                </p>
            </div>
        </dialog>
    </body>
