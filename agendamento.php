            ...
            <div class="form">
                <form action="login.php" method="post">
                    ...
                    <div class="title">
                        ...
                        <h6 class="subtitle">Verifique as informações abaixo e altere em caso <br> de necessidade para
                    ...
                    <div class="form-group mt-4">
                        <input type="text" maxlength="11" placeholder="Email" class="form-control"
